...
- [`mobx-zod-form`](https://github.com/MonoidDev/mobx-zod-form): Data-first form ***REMOVED***er based on MobX & Zod.
...
- TypeScript 4.5+!
- You must enable `strict` mode in your `ts***REMOVED***on`. This is a best practice for all TypeScript projects.
...
- Supports "pattern matching": computed properties that ***REMOVED***ribute over unions
